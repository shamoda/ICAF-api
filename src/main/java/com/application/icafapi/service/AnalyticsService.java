...
public class AnalyticsService {
    ...
    public Analytics getAnalytics() {
        ...
        Example<Researcher> exampleResearcher = Example.of(researcher);
        ...
        analytics.setPublishedPapers(researcherRepository.count(exampleResearcher));
        analytics.setPublishedWorkshops(workshopRepository.count(exampleWorkshop));  // implement logic to retrieve the approved editors posts count
